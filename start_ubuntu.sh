...
echo ""
echo "常用测试命令示例："
echo "curl -k https://192.168.0.168/health"
echo "curl -k -X POST -H 'Content-Type: application/json' -H 'Authorization: Bearer sk-test123456' -d '{\"messages\":[{\"role\":\"user\",\"content\":\"你好\"}]}' https://192.168.0.168/v1/chat/completions"
echo "curl -k -X POST -H 'Content-Type: application/json' -H 'Authorization: Bearer sk-test123456' -d '{\"prompts\":[\"你好\"],\"sampling_params\":{\"max_tokens\":50}}' https://192.168.0.168/generate"
echo ""
echo "请将 192.168.0.168 替换为实际服务器 IP，sk-test123456 替换为你的 AppKey。"
